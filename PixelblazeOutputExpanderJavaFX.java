...
public class PixelblazeOutputExpanderJavaFX extends Application {
    ...
    private void sendColors() {
        ...
        for (int led = 0; led < NUMBER_OF_LEDS; led++) {
            ...
            colors[3 * led] = (byte) (255 * color.getRed());
            colors[(3 * led) + 1] = (byte) (255 * color.getGreen());
            colors[(3 * led) + 2] = (byte) (255 * color.getBlue());
        }
        helper.sendColors(CHANNEL, 3, 1, 0, 2, 0, colors, true);
    }
